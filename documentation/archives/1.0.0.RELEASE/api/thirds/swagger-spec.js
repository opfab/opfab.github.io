  ...
  "paths" : {
    ...
    "/thirds/{thirdName}/media/{mediaFileName}" : {
      "get" : {
        ...
        "description" : "Get media file associated with Third, if file exists return file (audio/*) otherwise return error message (application/json)",
    ...
    "Third" : {
      ...
      "example" : {
        ...
        "medias" : {
          "JingleBells" : {
            "name" : "Jingle Bells",
            "files" : [ "jingle-bells.ogg", "vive-le-vent.ogg" ]
          },
          "Alarm" : {
            "name" : "Alarm sound",
            "files" : [ "smallProblem.ogg", "biggerProblem.ogg", "abandonShip.ogg" ]
          }
        },
        "menuEntries" : [ {
          "id" : "website",
